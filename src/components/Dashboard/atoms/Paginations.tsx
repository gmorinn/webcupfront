    ...
    return (
        <nav aria-label="Page navigation" className="flex justify-center items-center my-4">
            <ul className="inline-flex space-x-2">
                <li>
                    <button onClick={() => handlePrevious()} disabled={currentPage <= 0} className="flex items-center justify-center w-10 h-10 text-rose-600 transition-colors duration-150 rounded-full focus:shadow-outline hover:bg-rose-100">
                ...
                <li>
                    <button onClick={() => handleNext()} disabled={currentPage >= Math.ceil(totalPages / postsPerPage) - 1} className="flex items-center justify-center w-10 h-10 text-rose-600 transition-colors duration-15 rounded-full focus:shadow-outline hover:bg-rose-100">
