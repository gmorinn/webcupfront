    ...
    return (
        <div className="flex justify-around items-center">
            <Button
                ...
                styles="text-white bg-gradient-to-r from-rose-700 via-rose-600 to-rose-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-rose-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
